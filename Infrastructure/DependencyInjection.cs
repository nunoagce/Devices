...
public static class DependencyInjection
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddInfrastructureForTests()
        {
        ...
        {
            return services.AddScoped<IDeviceRepository, DeviceRepository>();
        }
    }
    ...
    {
        public async Task UseMigrationsAsync(bool isDevelopment)
        {
